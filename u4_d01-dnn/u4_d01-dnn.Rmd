...
4. Call the diffrentiation of $-l(\hat\beta)$ part a "Backward Propagation" step
5. Call our $\beta$ vector $W_{(q+1)\text{x}1}$, a weight matrix
6. Draw a diagram with circles and arrows, call these "Neurons", say something about the brain
