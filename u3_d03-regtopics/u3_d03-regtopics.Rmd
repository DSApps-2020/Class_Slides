...
<img src="images/covid19_whitehouse_bi.png" style="width: 80%" />
...
We've seen that if we know the knot we could fit MARS via `lm()`
...
But the matrix itself is slightly different than we would have expected.
